        ...
        <div class="col">
            ...
            <div class="wrapper--btn">
                ...
                if ( !empty( get_sub_field('button') ) ){
                    $buttonOne = get_sub_field('button');
            ...
            ?>
                ...
                <?php if ($buttonOne) : ?>
                    <a class="btn btn__coral" href="<?php echo $linkOne_url ?>" target="<?php echo $linkOne_target ?>"><?php echo $linkOne_title ?></a>
                <?php endif; ?>

                <?php if ($buttonTwo) : ?>
                    <a class="btn btn__dahlia" href="<?php echo $linkTwo_url ?>" target="<?php echo $linkTwo_target ?>"><?php echo $linkTwo_title ?></a>
                <?php endif; ?>
            </div>  
